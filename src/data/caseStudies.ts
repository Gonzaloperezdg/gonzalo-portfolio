...
export const CASE_STUDIES: CaseStudyData[] = [
  ...
  },
  {
    ...
    seoDescription: 'Tres generaciones de metodología AI-native en diez meses. De herramientas aisladas a workflow documentado y reproducible.',
    sections: [
      {
        id: 'context',
        title: 'El Punto de Partida',
      ...
      },
      {
        ...
        content: [
          'Evolución rápida y aprendizaje continuo. No es cuántos proyectos shipié. Es cómo mi proceso cambió en diez meses. De herramientas aisladas a metodología reproducible. De miedo a la terminal a trabajo nativo en CLI.',
    ...
    subProjects: [
      ...
      },
      {
        ...
        generation: 'Generación 3',
        period: 'Julio 2026',
        description: 'Un kit que le enseña a un agente de IA a construir portfolios de calidad producción, más un sitio web que guía paso a paso a personas sin conocimientos técnicos para que lo usen.',
        motivation: 'Quería ayudar a mis amigas a armar su portfolio. Tener uno es casi obligatorio para diseñadores y desarrolladores, pero armarlo cuesta tiempo y conocimiento: elegir stack, diseñar, escribir, optimizar imágenes, cuidar accesibilidad y SEO, publicarlo. Si de paso le servía a alguien más, mejor.',
        stack: ['Claude Code', 'Markdown', 'Node.js', 'HTML', 'CSS', 'JavaScript', 'Vercel'],
        workflow: [
          'Destilar la metodología de una construcción real: este mismo portfolio',
          'Claude Code desde terminal: 51 documentos organizados en 10 áreas',
          'Protocolo de anonimización, para no exponer datos de clientes bajo NDA',
          'Sitio web complementario sin build, en español e inglés',
          'Auditoría completa del kit y correcciones sobre lo detectado',
          'Deploy en Vercel',
        ],
        insights: [
          'Aprendí a generar galerías, y me gustó mucho ponerlo a prueba en un producto real',
          'El kit sale de patrones ya enviados a producción: cada error documentado lo cometí y lo resolví antes',
          'La anonimización no es un agregado: sin ella el kit no se puede compartir',
          'Construido en una noche, unas cuatro horas, con la metodología ya consolidada',
          'Queda mucho por mejorar. El objetivo es que sea lo más intuitivo y fácil posible',
        ],
        url: 'https://portfoliobuilder-gold.vercel.app/',
        status: 'completed',
      },
      {
        slug: 'catedra',
        ...
        description: 'Una app donde cargo mis apuntes y me arma cursos: los convierte en módulos, clases y evaluaciones, aplicando una metodología de diseño instruccional fija.',
        motivation: 'Quería estudiar un tema que no dominaba y decidí armarme la herramienta que me facilitara el estudio. El objetivo es traspolar temas complejos a capítulos y clases sencillas, para romper con la barrera de lo que parece difícil.',
        stack: ['Claude Code', 'Node.js', 'HTML', 'CSS', 'JavaScript', 'Supabase'],
        workflow: [
          'Claude Code desde terminal: investigación previa y estructura de la app',
          'Convención de carpetas: una carpeta es un curso, cada subcarpeta un módulo, cada archivo una clase',
          'Metodología de diseño instruccional fija: objetivos, secuencia por prerrequisitos y evaluación',
          'Supabase para cuentas, notas y progreso por usuario',
          'Iteración local y mejora continua',
        ],
        insights: [
          'Empezó como una herramienta para enfrentarme a temas que consideraba difíciles y bajarlos a conceptos básicos que pudiera entender',
          'Lo intimidante de un tema nuevo es muchas veces lo que frena el primer paso. La app existe para sacar esa barrera',
          'Que a otras personas les sirva es lo que más me motiva a seguir mejorándola',
          'La app corre sin instalar nada: no tiene dependencias externas ni paso de compilación',
          'De uso privado por ahora. La idea es liberarla cuando esté lista',
        ],
        status: 'active',
      },
    ],
...
const CASE_STUDIES_EN: CaseStudyData[] = [
  ...
  },
  {
    ...
    status: 'active',
    seoTitle: 'AI Experiments: Case Study | Gonzalo Daniel Pérez',
    seoDescription: 'Three generations of AI-native methodology in ten months. From isolated tools to documented and reproducible workflow.',
    sections: [
      {
        id: 'context',
        title: 'The Starting Point',
      ...
      },
      {
        ...
        content: [
          'Fast evolution and continuous learning. It\'s not how many projects I shipped. It\'s how my process changed in ten months. From isolated tools to reproducible methodology. From fear of the terminal to native CLI work.',
    ...
    subProjects: [
      ...
      },
      {
        ...
        generation: 'Generation 3',
        period: 'July 2026',
        description: 'A kit that teaches an AI agent to build production-quality portfolios, plus a website that walks non-technical people through using it, step by step.',
        motivation: 'I wanted to help my friends build their portfolios. Having one is close to mandatory for designers and developers, but building it costs time and knowledge: picking a stack, designing, writing, optimizing images, handling accessibility and SEO, shipping it. If it helped anyone else along the way, even better.',
        stack: ['Claude Code', 'Markdown', 'Node.js', 'HTML', 'CSS', 'JavaScript', 'Vercel'],
        workflow: [
          'Distill the methodology from a real build: this very portfolio',
          'Claude Code from the terminal: 51 documents across 10 areas',
          'Anonymization protocol, so no client data under NDA is ever exposed',
          'Companion website with no build step, in Spanish and English',
          'Full audit of the kit and fixes for everything it surfaced',
          'Deploy on Vercel',
        ],
        insights: [
          'I learned to build galleries, and I really enjoyed putting that to the test in a real product',
          'The kit comes from patterns already shipped to production: every documented mistake is one I made and solved first',
          'Anonymization is not an add-on. Without it the kit cannot be shared at all',
          'Built in one night, roughly four hours, with the methodology already consolidated',
          'Plenty left to improve. The goal is to make it as intuitive and easy as possible',
        ],
        url: 'https://portfoliobuilder-gold.vercel.app/',
        status: 'completed',
      },
      {
        ...
        description: 'An app where I load my notes and it builds courses out of them: turning them into modules, lessons and assessments, following a fixed instructional design methodology.',
        motivation: 'I wanted to study a topic I did not know well, so I decided to build the tool that would make studying it easier. The goal is to translate complex subjects into simple chapters and lessons, breaking the barrier of what looks difficult.',
        stack: ['Claude Code', 'Node.js', 'HTML', 'CSS', 'JavaScript', 'Supabase'],
        workflow: [
          'Claude Code from the terminal: upfront research and app structure',
          'Folder convention: a folder is a course, each subfolder a module, each file a lesson',
          'Fixed instructional design methodology: objectives, prerequisite-ordered sequence and assessment',
          'Supabase for accounts, notes and per-user progress',
          'Local iteration and continuous improvement',
        ],
        insights: [
          'It started as a tool to face subjects I considered hard and bring them down to basic concepts I could actually grasp',
          'What stops the first step is often how intimidating a new subject looks. The app exists to remove that barrier',
          'Knowing it helps other people is what motivates me most to keep improving it',
          'The app runs without installing anything: no external dependencies, no build step',
          'Private for now. The idea is to release it once it is ready',
        ],
        status: 'active',
      },
    ],
