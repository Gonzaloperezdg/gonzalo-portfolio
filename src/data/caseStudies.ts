    ...
    sections: [
      {
        ...
        title: 'El Contexto',
        content: [
          'InsurTech Global es una tech company con sede en Bryan, Texas, con equipos en Argentina, Sudáfrica, Portugal y Escocia. Desarrolla soluciones de software para empresas de seguros y gestión de riesgos.',
          ...
          'A lo largo de ese camino hubo varios proyectos. Acá me enfoco en dos que marcaron mi desarrollo: el trabajo con Proyecto 1 y luego con Proyecto 2.',
        ],
      },
    ],
    subProjects: [
      {
        slug: 'proyecto-1',
        title: 'Proyecto 1 — Design System',
        period: 'Agosto 2021 – 2023',
        description: 'Expansión de un sistema de diseño existente para Proyecto 1, empresa de seguros cliente de InsurTech Global.',
        status: 'completed',
        sections: [
          {
            id: 'context',
            title: 'El Proyecto',
            content: [
              'Proyecto 1 es una de las empresas de seguros para las que InsurTech Global desarrolla soluciones. Al incorporarme al proyecto, existía un sistema de diseño incipiente con algunos componentes base, y el desafío era llevarlo a un nivel que pudiera sostener el crecimiento del producto.',
      ...
      {
        slug: 'proyecto-2',
        title: 'Proyecto 2 — Liderazgo e IA',
        period: '2024 – Presente',
        description: 'Nuevo proyecto, nuevo cliente, nuevo rol. En Proyecto 2 asumí el liderazgo del equipo de diseño y más tarde integré IA al flujo de trabajo.',
        status: 'active',
        sections: [
          {
            id: 'context',
            ...
            content: [
              'Proyecto 2 es otro cliente de InsurTech Global. Ingresé al proyecto en 2024, en un momento en que el producto estaba en construcción activa: había pantallas por diseñar, un sistema de diseño por armar, y una identidad visual de producto que definir.',
