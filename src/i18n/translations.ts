export const translations = {
  es: {
    ...
    about_origin_p1: 'De niño conocí Paint en una computadora vieja, y ahí empezó todo. Mi tío me regaló mi primera computadora con Corel Draw e Illustrator — y desde entonces el diseño digital fue parte de mi vida antes de que supiera que podía ser una carrera.',
    ...
    about_driving_p1: 'Trabajo con tres tipos de empatía en simultáneo:',
    ...
    about_driving_p2: 'No siempre los tres están al mismo nivel. Pero los tres tienen que estar en la ecuación. El diseño que ignora al negocio no dura. El diseño que ignora al usuario no funciona. El diseño que ignora al equipo no escala.',
    about_ai_title: 'Mi Postura sobre la IA',
    about_ai_p1: 'Empecé a usar herramientas de IA como cualquier otra persona: de a una, para tareas específicas, sin pensar demasiado en el sistema.',
    about_ai_p2: 'En algún momento eso cambió.',
    about_ai_p3: 'Hoy la IA no es una herramienta en mi flujo de trabajo. Es la metodología misma. Eso implica decidir qué delego y qué no, evaluar los resultados, documentar el proceso, y mantener el criterio humano en cada punto de decisión.',
    about_ai_p4: 'La IA sin dirección es ruido. Con dirección, es un multiplicador de capacidad.',
    about_ai_p5: 'Lo que diferencia mi forma de trabajar no es qué herramientas uso. Es que sé por qué las estoy usando.',
    about_offline_title: 'Afuera de la Pantalla',
    about_offline_p1: 'Cuando no estoy diseñando, trato de hacer lo opuesto.',
    about_offline_p2: 'Dibujo — arte analógico, sin capas de Figma ni estados de componentes. Camino por la costanera. Y vendo mis dibujos en ferias, lo mismo que me llevó a construir FeriaFlow, la app que armé para gestionar mis propias ventas.',
    about_offline_p3: 'Hay algo en el arte físico que recarga lo que el digital gasta. No es contradicción — es equilibrio.',
    about_contact_title: 'Hablemos',
    about_contact_p1: 'Estoy disponible para proyectos de UX/UI donde el proceso importe tanto como el resultado. Si buscás un diseñador que investigue antes de hacer, que entienda el negocio además del usuario, y que trabaje con metodología AI-native sin perder el criterio propio — escribime.',
  ...
  en: {
    ...
    about_discovery_p5: 'I apply that same criteria to design: if the user doesn\'t understand it, it\'s a design problem, not a user problem.',
    about_driving_title: 'What Drives Me',
    about_driving_p1: 'I work with three types of empathy simultaneously:',
    ...
    about_driving_p2: 'The three are not always at the same level. But all three must be in the equation. Design that ignores business doesn\'t last. Design that ignores users doesn\'t work. Design that ignores the team doesn\'t scale.',
    about_ai_title: 'My Stance on AI',
    about_ai_p1: 'I started using AI tools like anyone else: one by one, for specific tasks, without thinking too much about the system.',
    about_ai_p2: 'At some point, that changed.',
    about_ai_p3: 'Today, AI is not a tool in my workflow. It IS the methodology. That implies deciding what I delegate and what I don\'t, evaluating the results, documenting the process, and keeping human criteria at every decision point.',
